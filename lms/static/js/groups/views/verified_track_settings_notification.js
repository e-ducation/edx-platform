                            ...
                            if (verifiedCohortExists) {
                                this.showNotification({
                                    ...
                                    title: StringUtils.interpolate(
                                        gettext("This course uses automatic cohorting for verified track learners. You cannot disable cohorts, and you cannot rename the manual cohort named '{verifiedCohortName}'. To change the configuration for verified track cohorts, contact your Elite A.I. Academy partner manager."),  // eslint-disable-line max-len
